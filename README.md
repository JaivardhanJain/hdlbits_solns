...
| 65 | [Hadd](03_circuits/combinational/arithmetic/65.%20Hadd/README.md) | Circuits: Combinational (Arithmetic) | ⭐ | Half adder: `sum = a^b`, `cout = a&b` — plus the `{cout,sum} = a+b` arithmetic alternative. |
| 66 | [Fadd](03_circuits/combinational/arithmetic/66.%20Fadd/README.md) | Circuits: Combinational (Arithmetic) | ⭐ | Full adder: `sum = a^b^cin`, `cout` as a 3-term majority vote — plus the `{cout,sum} = a+b+cin` arithmetic alternative. |
| 67 | [Adder3](03_circuits/combinational/arithmetic/67.%20Adder3/README.md) | Circuits: Combinational (Arithmetic) | ⭐⭐ | 3-bit ripple-carry adder built from three chained `fa` instances — positional instantiation, carry chaining, and why ripple-carry doesn't scale. |
| 68 | [Exams_m2014_q4j](03_circuits/combinational/arithmetic/68.%20Exams_m2014_q4j/README.md) | Circuits: Combinational (Arithmetic) | ⭐⭐ | 4-bit adder from a given 4-FA schematic — structural vs. behavioural modelling, side by side. |
